export const experienceData = [
  {
    ...
    description:
      ['[ L ]Market is a nft Next-JS app interacting with Ledger Live and in the middle of the whole B2C activities. The project is composed of various features and areas (Blockchain explorers, Front, Smart Contracts, Nano apps, wallet interractions, dApps integration in ledger Live dev platform...)',
      ...
      'UI test framework Implementation (Playwright). Smart contract testing (Hardhat), Blockhcain explorers and indexer',
      'integration in the e-commerce checkout flow for pysical NFT'
      ]
  ...
  },
  {
    ...
    description: ['As the first QA on the project I have been implicated in the Ledger Live app development from the first line of code',
    'I built the QA team, onboard and drive new comers',
    'As the team Lead I was the Entry point of the B2C team for devs and support activities (Backend, Customer Support, Coin Integration, FW, HW, Front)',
    'I Established the global QA approach: UI Regression and internal logic, Device interractions (BLE / USB)',
    'UI Actively participated in the setup of regression UI automation framework, transactions tests.'
  ]
  },
  {
    id:3,
    title: 'QA Engineer - TVTY',
    duration: '2016-2018',
  ...
  },
  {
    ...
    duration:'2012 - 2016',
    description:'After an experience as a Product Owner I moved to QA where I actively took in charge implemntation of the whole QA strategy for the existing e-commerce website (user flows, Checkout / Payment...)\nAccomplishments: website v3, DLM marketplace (Mirakl integration), iOS app.\n Implementation of UI automation (Robot Framework)',
  }
]