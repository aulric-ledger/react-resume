    ...
    <div className='contact'>
      ...
      <div className='contactContent'>
        <div className='emailContent'>
          ...
          <button id='copy-email' onClick={()=>copyContact(email)}><i className='fas fa-copy'></i></button>
        </div>
        <div className='phoneContent'>
          <h3>Phone</h3>
          <button id='phoneTo' onClick={()=>window.open(`tel:${phone}`)}><i className='fas fa-phone'></i>{phone}</button>
          <button id='copy-phone' onClick={()=>copyContact(phone)}><i className='fas fa-copy'></i></button>
        </div>
      </div>
    </div>
  );
